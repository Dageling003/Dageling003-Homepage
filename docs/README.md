...
| 🚀 部署（小白版） | [deploy-beginner.md](./deploy-beginner.md) | 零 Docker / 零 Linux 经验的读者 | 第一次买服务器上线，想一步一步跟着做 |
| 🚀 部署（完整版） | [deployment.md](./deployment.md) | 自托管站长 / 运维 | Docker / 手动部署 / 环境变量配置时 |
...
- **想上线自己的实例** → 根 [README](../README.md) → [deploy-beginner.md](./deploy-beginner.md)（零基础）或 [deployment.md](./deployment.md)（有 Docker 经验）
